...
class HigherEdSolver:
    def initialize(self, institutions):
        ...
        for institution in institutions:
            self.parent[institution] = institution

    def parent_institution(self, institution):
        # Skriv din kode her
        if institution not in self.parent:
            self.parent[institution] = institution
            return institution
        
        if self.parent[institution] != institution:
            self.parent[institution] = self.parent_institution(self.parent[institution])
        
        return self.parent[institution]

    def fuse(self, institution1, institution2, new_institution):
        # Skriv din kode her
        r1 = self.parent_institution(institution1)
        r2 = self.parent_institution(institution2)

        if new_institution not in self.parent:
            self.parent[new_institution] = new_institution
        else:
            self.parent[new_institution] = new_institution
        
        self.parent[r1] = new_institution
        self.parent[r2] = new_institution
